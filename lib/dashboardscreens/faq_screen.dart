...
class _FAQScreenState extends State<FAQScreen> {
  ...
  void _openWhatsApp() async {
    const String phoneNumber = "9490657008";
  ...
  /* ---------------------- FAQ LIST ---------------------- */
  List<Widget> _buildFAQList(LocalizationProvider localization, bool isEnglish) {
    final faqs = [
      {
    ...
    // 🔄 filter only in English
    final filteredFaqs = isEnglish
        ? faqs.where((faq) {
      ...
      return Column(
        children: [
          _buildFAQItem(
            ...
            index == expandedIndex,
            () {
              setState(() => expandedIndex = index == expandedIndex ? -1 : index);
            },
            context,
          ),
          const Divider(),
