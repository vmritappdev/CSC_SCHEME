...
void main() {
  runApp(MaterialApp(
    ...
    home: const TermsAndConditionsScreen3(),
  ));
}

class TermsAndConditionsScreen3 extends StatefulWidget {
  const TermsAndConditionsScreen3({super.key});

  @override
  State<TermsAndConditionsScreen3> createState() => _TermsAndConditionsScreen3State();
}

class _TermsAndConditionsScreen3State extends State<TermsAndConditionsScreen3> {
